...
export class MsgIssueDenom {
  ...
  type: MsgType;
  private static _protobufType: ProtoBufType = pbs.nft_tx_pb.MsgIssueDenom;
...
export class MsgMintNFT {
  value: NFTParams;
  type: MsgType;
  private static _protobufType: ProtoBufType = pbs.nft_tx_pb.MsgMintNFT;
...
export class MsgEditNFT {
  ...
  type: MsgType;
  private static _protobufType: ProtoBufType = pbs.nft_tx_pb.MsgEditNFT;
...
export class MsgTransferNFT {
  ...
  type: MsgType;
  private static _protobufType: ProtoBufType = pbs.nft_tx_pb.MsgTransferNFT;
  private doNotModifyFlag: string = '[do-not-modify]';
  defaults: NFTDefaultBlankFieldValues = {
    name: this.doNotModifyFlag,
    uri: this.doNotModifyFlag,
...
export class MsgBurnNFT {
  ...
  type: MsgType;
  private static _protobufType: ProtoBufType = pbs.nft_tx_pb.MsgBurnNFT;
